...
namespace RaynMaker.Import.Parsers
{
    class TableFormatter
    {
        ...
        /// </summary>
        public static DataTable ToFormattedTable(AbstractTableFormat format,  DataTable rawTable )
        {
        ...
        public static void ToFormattedTable( AbstractTableFormat format, DataTable rawTable, DataTable targetTable )
        {
        ...
        /// </remarks>
        /// </summary>
        public static DataTable ToFormattedTable(AbstractSeriesFormat format, DataTable table_in )
        {
            if( table_in == null )
            {
        ...
        /// </summary>
        public static TableExtractionSettings ToExtractionSettings(AbstractSeriesFormat format)
        {
        ...
        private static DataTable ExtractSeries( AbstractSeriesFormat format, DataTable rawTable, Anchor anchor_in )
        {
            if( anchor_in == null )
            {
