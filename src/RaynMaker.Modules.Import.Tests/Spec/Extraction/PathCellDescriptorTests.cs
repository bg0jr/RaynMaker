...
namespace RaynMaker.Modules.Import.Tests.Spec.Extraction
{
    ...
    public class PathCellDescriptorTests
    {
        ...
        public void Column_Set_ChangeIsNotified()
        {
            ...
            Assert.That(counter.GetCount(nameof(descriptor.Column)), Is.EqualTo(1));
        }
        ...
        public void Row_Set_ChangeIsNotified()
        {
            ...
            Assert.That(counter.GetCount(nameof(descriptor.Row)), Is.EqualTo(1));
        }
        ...
        public void Validate_MisingColumn_Throws()
        {
            ...
            var ex = Assert.Throws<ValidationException>(() => RecursiveValidator.Validate(descriptor));
            Assert.That(ex.Message, Does.Contain("The Column field is required"));
        }
